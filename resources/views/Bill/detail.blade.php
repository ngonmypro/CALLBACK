                            ...
                            @if( $data->status == 'ACTIVE' )
                                @if ( isset( $data->bill_status ) && isset( $data->payment_status ) )
                                    @if ( $data->bill_status !== 'INACTIVE' && !in_array( $data->payment_status, ['DUPLICATE_PAID', 'CANCELLED'] ) )
                                        ...
                                        <!-- REPAYMENT -->
                                        @if ( in_array( $data->payment_status, ['NEW', 'PENDING', 'UNPAID', 'REJECT'] ) ) 
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="p-2 flex-fill w-50">
                                <div class="form-group">        
                                    <div class="row">
                                        <div class="col-12">
                                            <label for="" class=" form-control-label">payment_url</label>
                                        </div>
                                        <div class="col-12">
                                            <label for="" class=" form-control-label">{{ isset($data->payment_url) && !blank($data->payment_url) ? $data->payment_url : '-' }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-wrap">
                           <div class="p-2 flex-fill w-50">
                               <div class="form-group">        
                                   <div class="row">
                                       <div class="col-12">
                                           <label for="" class=" form-control-label">Export_date</label>
                                       </div>
                                       <div class="col-12">
                                           <label for="" class=" form-control-label">{{ isset($data->export_date) && !blank($data->export_date) ? $data->export_date : '-' }}</label>
                                       </div>
                                   </div>
                               </div>
                           </div>
                                ...
                                <div class="row p-3">
                                    <div class="col-12 text-left">
                                        ...
                                        @if ( !blank($data->payment_channel ?? null) ) 
                                            <input type="text" class="form-control" name="payment_channel" id="payment_channel" placeholder="{{__('bill.detail.repayment.required')}}" value="{{ $data->payment_channel }}" {{ $data->payment_channel != "RECURRING" ? 'readonly' : '' }} >
                                        @else
