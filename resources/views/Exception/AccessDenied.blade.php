 ...
 <body>
    ...
    <div class="d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="w-100 text-center px-4">
            <img src="{{ URL::asset('assets/images/access-denied.png') }}" class="pl-5 mb-3 img-fluid" width="400">
        </div>
        <div class="w-100 text-center px-4">
            <h1 style="font-size: 36px !important;">Access Denied</h1>
        </div>
        <div class="w-100 text-center px-4">
            <p style="font-size: 24px !important;">You have to subscribe enterpirse plan for access.</p>
        </div>
        <div class="w-100 text-center px-4">
