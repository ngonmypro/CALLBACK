...
<head>
 ...
 <body>
    ...
    <div class="d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="w-100 text-center px-4">
            <p style="font-size: 24px !important;">We can't find the page you're looking for. head back to home.</p>
        </div>
        <div class="w-100 text-center px-4">
            <button type="button" class="btn btn-dark" onclick="window.location.href='/'">Home</button>
            <button type="button" class="btn btn-outline-dark" onclick="window.history.back();">Back</button>
        </div>
    </div>
