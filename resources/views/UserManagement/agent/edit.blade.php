            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right d-none">
                        <a href="{{ action('Agent\UserManagementController@index') }}" class="btn btn-neutral">{{__('common.cancel')}}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col">
                ...
                <form action="{{ action('Agent\UserManagementController@edit_submit') }}" method="post" enctype="multipart/form-data" id="form-edit-user">
                    {{ csrf_field() }}
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <div class="text-center">
                                            <a href="{{ action('Agent\UserManagementController@index') }}" class="btn btn-warning mt-3">{{ __('common.cancel') }}</a>
