            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <form action="{{ action('Agent\UserManagementController@create_submit')}}" method="post" enctype="multipart/form-data" id="form-create-user">
                                {{ csrf_field() }}
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <div class="text-center">
                                            <a href="{{ action('Agent\UserManagementController@index')}}" id="btn_cancel" class="btn btn-warning mt-3">{{__('common.cancel')}}</a>
