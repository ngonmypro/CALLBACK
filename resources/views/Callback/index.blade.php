                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Callback</h6>
                        </div>
		...
		$(document).ready(function(){
			...
			var table = $("#bill_table").DataTable({
				...
				columns: [
					...
					{ data: 'response_code',          name: 'response_code',                title: "response_code"   },
                    { data: 'document',           name: 'document',                 title: "document"   },
                    { data: 'status_file',           name: 'status_file',                 title: "status_file"   },
