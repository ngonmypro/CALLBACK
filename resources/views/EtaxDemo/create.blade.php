...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <div class="col-xl-12">
            <form id="form_bill_invoice" class="item-form" action="{{ url('/Create_post') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="text" class="form-control" name="recipient_lastname" placeholder="{{ __('bill.simple.recipient_name_placeholder') }}" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="text" class="form-control" name="recipient_telephone" placeholder="{{ __('bill.simple.recipient_telephone_placeholder') }}" maxlength="11"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            <label class="form-control-label text-truncate">{{ __('bill.simple.address') }}</label>
                                            <input type="text" class="form-control" name="address" placeholder="{{ __('bill.simple.address') }}" />
                                        </div>
                                    </div>

                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            <label class=" form-control-label text-truncate">{{__('corporateManagement.Province')}}<span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            ...
                                            <select class="form-control sub-district" name="select_sub_district" data-bank="{{Session::get('BANK_CURRENT')['name_en'] == 'KBANK' ?  'KBANK'  : ''}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="text" class="form-control" name="select_zipcode" value="{{ old('select_zipcode') }}" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group my-2">
                                            ...
                                            <select class="form-control country-code" name="country_code" data-bank="{{Session::get('BANK_CURRENT')['name_en'] == 'KBANK' ?  'KBANK'  : ''}}">
                                                <option value="TH">{{__('corporateManagement.thailand')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <input type="hidden" class="form-control" name="zipcode_address">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="form-group my-2">
                                            ...
                                            <input type="text" name="branch_name" id="branch_name" class="form-control" placeholder="00000" />
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-6">
                        <div class="text-left">
                            <a href="{{ URL::to('/')}}" id="btn_cancel" class="btn btn-outline-primary mt-3">{{__('common.cancel')}}</a>
                        </div>
                    </div>

                    <div class="col-6">
                        <div class="text-right">
                            <button type="" id="btn_submit" class="btn btn-primary mt-3">{{__('common.create')}}</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btn_submit').on('click', function() {
            // $.blockUI()
            $('#form_bill_invoice').ajaxForm({
                success: function(responseData){
                    // $.unblockUI()
                    if (responseData.success == true) {
                        Swal.fire("Success!", responseData.message, 'success').then(function() {
                                            // $.unblockUI()
