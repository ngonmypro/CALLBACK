                    ...
                    <div class="card-body">
                        <div class="row p-2">
                            <div class="col-xl-6">
                                ...
                                <div class="row pl-2">
                                    <div class="col-6">
                                        <input class="radio" type="radio" id="eipp" name="app_type" value="EIPP"  onchange="appType('EIPP')" {{ $pdf_template->app_type == 'EIPP' ? 'checked' : ''}} > 
                                        <label for="eipp">Don't Signature Sign</label>
                                    </div>
                                    <div class="col-6">
                                        <input class="radio" type="radio" id="etax" name="app_type" value="ETAX" onchange="appType('ETAX')"  {{ $pdf_template->app_type == 'ETAX' ? 'checked' : ''}}>
                        ...
                        <div class="row p-2">
                            <div class="col-xl-6">
                                ...
                                <input class="form-control" type="text" id="template_name" name="template_name" value="{{$pdf_template->template_name}}"/>
                                <input type="hidden" id="corp_code" name="corp_code" value="{{ $corp_code }}"/>
                                <input type="hidden" name="method" value="update"/>
                                <input type="hidden" name="reference" value="{{$pdf_template->reference}}"/>
                            </div>
                            <div class="col-xl-6">
                                ...
                                <select id="" name="document_type" class="form-control">
                                    @foreach($documents as $doc_type)
                                        <option value="{{ $doc_type->name }}" {{ $pdf_template->document_type == $doc_type->name ? 'selected' : '' }}>{{$doc_type->name_en}} | {{$doc_type->name_th}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row p-2">
                            <div class="col-xl-6">
                                ...
                                <input class="form-control" type="number" id="max_record" name="max_record" min="1" max="5" value="{{$pdf_template->max_record}}"/>
                            </div>
                            <div class="col-xl-6">
                                <label for="" class="form-control-label">{{__('corpsetting.status')}}</label>
                                <div class="form-control-label p-2">
                                    <input class="form-control-label" id="active" type="radio" name="status" value="ACTIVE"  {{ $pdf_template->status == 'ACTIVE' ? 'checked' : ''}}> <label for="active"> {{__('common.active')}}</label>
                                    <input class="form-control-label" id="inactive" type="radio" name="status" value="INACTIVE" {{ $pdf_template->status == 'INACTIVE' ? 'checked' : ''}}> <label for="inactive"> {{__('common.inactive')}}</label>
                                </div>
                            </div>
                        </div>
                        <div class="row p-2">
                            <div class="col-xl-6">
                                <label for="" class="form-control-label">{{__('corpsetting.select_file')}}dddd</label><br/>
                        ...
                        <div class="d-none" id="for-etax-section">
                            ...
                            <div class="row p-2">
                                <div class="col-xl-6">
                                    ...
                                    <div class="row pl-2">
                                        <div class="col-6">
                                            ...
                                            <input id="dsVisibility" type="radio" name="ds_visibility" value="false" class="magic-radio green-check" {{ $signatureDetail['visibility'] == 'false' ? 'checked' : ''}}   onchange="SignatureVisible('false');">
                                            <label for="dsVisibility">Hidden</label> 
                                        </div>
                                        <div class="col-6">
                                            <input id="dsVisibility-true" type="radio" name="ds_visibility" value="true" class="magic-radio green-check" {{ $signatureDetail['visibility'] == 'true'  ? 'checked' : ''}}  onchange="SignatureVisible('true');">
                                ...
                                <div class="col-xl-6 visibility d-none">
                                    ...
                                    <div class="row pl-2">
                                        <div class="col-6">                                                                    
                                            <input id="page-true" type="radio" name="page" value="first" class="magic-radio green-check"     {{ isset($signatureDetail['page']) && $signatureDetail['page']  == 'first'  ? 'checked' : '' }}>
                                            <label for="page-true">First page</label>
                                        </div>
                                        <div class="col-6">
                                            <input id="page" type="radio" name="page" value="last" class="magic-radio green-check"        {{ isset($signatureDetail['page']) && $signatureDetail['page']  == 'last'  ? 'checked' : ''}} >
                            ...
                            <div class="row p-2 visibility d-none">
                                <div class="col-xl-6">
                                    <label for="" class="form-control-label">{{__('corpsetting.signature_type')}} {{$signature_type}}</label>
                                    <div class="row pl-2">
                                        <div class="col-6">
                                            <input id="signature_sign_text" id="text" type="radio" class="magic-radio green-check" name="signature_type" {{ $signature_type == 'TEXT' ? 'checked' : ''}} value="TEXT" data-disabled="true" onchange="SignatureType('TEXT')" data-check="checked" data-type="text" data-input="old" data-index="0">
                                        ...
                                        <div class="col-6">
                                            <input id="signature_sign_picture"  type="radio" class="magic-radio green-check" name="signature_type" {{ $signature_type == 'IMAGE' ? 'checked' : ''}} value="IMAGE" onchange="SignatureType('IMAGE')" data-input="old" data-check="" data-type="image" data-index="0">
                                        ...
                                        <div class="col-12">
                                            <div class="font-type pt-2">
                                                ...
                                                <div class="pr-4">
                                                    <input class="form-control" name="signature_text" id="signature_text"  value="{{ $signatureDetail['signature_text'] }} "  type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="image-type pt-2 d-none">
                                            <div class="col-12">
                                                <label class="template-text">Browse Image <span>({{__('corpsetting.file_size_limit')}} 400 kb)</span></label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var etax = $("#etax:checked").val()
        var  visibility = $("#dsVisibility-true:checked").val()

        var  text = $("#signature_sign_text:checked").val()
        var  image = $("#signature_sign_picture:checked").val()
    ...
    const oldData = `{!! json_encode($pdf_template) !!}`
