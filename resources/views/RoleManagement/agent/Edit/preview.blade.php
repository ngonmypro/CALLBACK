            ...
            <div class="header-body">
               <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        @Permission(AGENT_ROLE_MANAGEMENT.EDIT_ROLE_DETAIL)
                            <a href="{{ action('Agent\RoleManagementController@EditRolePermission', ['code' => $code]) }}" class="btn btn-neutral">{{__('common.edit')}}</a>
                        @EndPermission
                    </div>
                </div> 
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="create_role" class="item-form" action="{{ action('Agent\RoleManagementController@UpdateRoleAndPermission') }}" method="post" enctype="multipart/form-data" id="update-permission">
