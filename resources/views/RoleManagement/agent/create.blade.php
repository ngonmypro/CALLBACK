            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right d-none">
                        <a href="{{ action('Agent\RoleManagementController@agent_role_page_index') }}" class="btn btn-neutral">{{__('common.back')}}</a>
                    </div>
                </div> 
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="create_role" class="item-form" action="{{ action('Agent\RoleManagementController@SubmitCreateRole')}}" method="post" enctype="multipart/form-data">
...
<script>
    ...
    perm.getPermission = (callback = null) => {
        ...
        webRequest('POST', `{{ action('Agent\RoleManagementController@GetPermissions') }}`, data,
            function(err, result) {
                ...
                if (err) {
                    ...
                    if ($('#user_group option').length <= 1) {
                        ...
                        $('#user_group').append('<option value="AGENT">AGENT</option>')
                    }
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#user_group', function() {
            ...
            webRequest('POST', `{{ action('Agent\RoleManagementController@GetObjectType') }}`, data,
                function(err, result) {
                    if (err) {
                        console.error(err)
