        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    @Permission(CORPORATE_ROLE_MANAGEMENT.CREATE_ROLE)
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ action('Corporate\RoleManagementController@CreateRole') }}" class="btn btn-neutral">{{__('role.add_new_role')}}</a>
                    </div>
                    @EndPermission
                </div> 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#roles").DataTable({
            ...
            ajax: {
                url: '{{ action("Corporate\RoleManagementController@objectData_corporate_role") }}',
                method: 'POST',
                data: function (d) {
                    d._token    = "{{ csrf_token() }}",
            ...
            columns: [
                ...
                @Permission(CORPORATE_ROLE_MANAGEMENT.VIEW_ROLE_DETAIL)
            ...
            aoColumnDefs: [
                ...
                @Permission(CORPORATE_ROLE_MANAGEMENT.VIEW_ROLE_DETAIL)
                {
                    ...
                    "mData": null,
                    "mRender": function (data, type, full) {
                        let path = `{{ action('Corporate\RoleManagementController@RoleAndPermission', ['code' => '%%CODE%%']) }}`
