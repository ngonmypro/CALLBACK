...
{   
    ...
    public function GetRoleDetail(Request $request)
    {
        try {
            ...
            report($e);
            return esponse()->json(null);
        }
    }

    public function CreateRole()
    {
        return view('RoleManagement.corporate.create');
    }
    ...
    public function CreatePermission()
    {
        try {
            ...
            if ($data->success == true) {
                ...
                return view('RoleManagement.corporate.Create.Permission', compact('permission_list'));
            } else {
                return redirect()->back()->withInput()->with([
                    'alert-class'  => 'alert-danger',
    ...
    public function RoleAndPermission($code)
    {
        ...
        return view('RoleManagement.corporate.Edit.preview', compact('data', 'code'));
    }
    ...
    public function EditRolePermission($code)
    {
        ...
        return view('RoleManagement.corporate.Edit.edit', compact('data', 'code'));
    }
