...
{   
    ...
    {
        return view('RoleManagement.agent.create');
    }
    ...
    public function CreatePermission()
    {
        try {
            ...
            if ($data->success == true) {
                ...
                return view('RoleManagement.agent.Create.Permission', compact('permission_list'));
            } else {
                return redirect()->back()->withInput()->with([
                    'alert-class'  => 'alert-danger',
    ...
    public function RoleAndPermission($code)
    {
        ...
        return view('RoleManagement.agent.Edit.preview', compact('data', 'code'));
    }
    ...
    public function EditRolePermission($code)
    {
        ...
        return view('RoleManagement.agent.Edit.edit', compact('data', 'code'));
    }
