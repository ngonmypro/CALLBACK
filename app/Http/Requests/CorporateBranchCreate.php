...
class CorporateBranchCreate extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'modal_short_name_en'               => 'required|min:4|max:30|regex:/^[A-Za-z0-9\(\)\.\-\,]+$/i',
            'modal_contact'                     => 'max:300|regex:/^[^\s]+$/i',
            'modal_branch_province'             => 'required',
            'modal_branch_district'             => 'required',
            'modal_branch_sub_district'         => 'required',
            'modal_branch_zipcode'              => 'required',
            'modal_house_no'                    => 'required|max:16|regex:/^\d+[0-9\-\/]*$/',
            'modal_building'                    => 'max:70',
            'modal_lane'                        => 'max:70',
            'modal_village'                     => 'max:70',
            'modal_village_no'                  => 'max:70',
